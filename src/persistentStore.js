...
const storedCurrentLayout =
  localStorage.getItem("fngrng_currentLayout") || "colemakdh";
...
export const currentLayout = derived(
  [currentFixedLayout, useCustomLayout],
  ([$currentFixedLayout, $useCustomLayout]) =>
    $useCustomLayout ? "custom" : $currentFixedLayout
);
...
const storedLevelMaps =
  JSON.parse(localStorage.getItem("fngrng_levelMaps")) || levelLetterSets;
...
export const storedCustomKeyMap =
  JSON.parse(localStorage.getItem("fngrng_customKeyMap")) || emptyCustomKeyMap;
...
const storedKeyRemapping =
  localStorage.getItem("fngrng_keyRemapping") || "true";
...
const storedUseColumnarLayout = localStorage.getItem(
  "fngrng_useColumnarLayout"
);
...
const storedUppercaseAllowed =
  localStorage.getItem("fngrng_uppercaseAllowed") || "false";
...
export const fullSentenceModeEnabled = writable(
  storedFullSentenceMode === "true"
);
...
const storedWordScrollingMode =
  localStorage.getItem("fngrng_wordScrollingMode") || "true";
export const wordScrollingModeEnabled = writable(
  storedWordScrollingMode === "true"
);
